    ...
    public static class PredefiniedAssemblerDefinition
    {
        public static AssemblerDefinition GetDefinition()
        {
            ...
            assemblerDefinition.Definitions = new List<InstructionDefinition>
            {
                ...
                new InstructionDefinition{ Name=$"{Inst.reallocl}",  ID=(int)Inst.reallocl, OP0DT=1, OP0REG=true, OP1DT=1,OP1REG=true,OP2DT=1, OP2REG=true},
                ...
                new InstructionDefinition{ Name=$"{Inst.bcmpi}",  ID=(int)Inst.cmp, OP0DT=1, OP0REG=true, OP1DT=1,OP1REG=true,OP2DT=1, OP2REG=false},
                new InstructionDefinition{ Name=$"{Inst.bcmpi}",  ID=(int)Inst.cmp, OP0DT=1, OP0REG=true, OP1DT=1,OP1REG=true,OP2DT=1, OP2REG=false},

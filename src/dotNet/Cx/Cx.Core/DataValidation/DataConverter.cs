...
namespace Cx.Core.DataTools
{
    ...
    //        }
    //    }
    //    public static bool TryParse(string input , out float data)
    //    {
    //        bool Negative = input.StartsWith("-");
    //        input = input.ToUpper();
    //        int Start = 0;
